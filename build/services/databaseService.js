...
var createNewContainer = function (containerId, port) { return __awaiter(void 0, void 0, void 0, function () {
    var err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.container.create({
                        data: {
                            id: 1,
...
var updateContainerStatus = function (containerId, status) { return __awaiter(void 0, void 0, void 0, function () {
    var err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.container.update({
                        where: {
                            container_id: containerId
                        },
                        data: {
...
var deleteContainer = function (containerId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.container.delete({
                        where: {
                            container_id: containerId
                        },
                    })];
